...
mydata<-read_xlsx('C:\\Users\\Francesco\\Desktop\\Progetti\\Diff Network Analysis R\\dati.xlsx',col_types="numeric")

dataf<-data.frame(mydata)

Label<-read_xlsx('C:\\Users\\Francesco\\Desktop\\Progetti\\Diff Network Analysis R\\label_2.xlsx')

labelf <- data.frame(Label)$Sesso
...
result <- chNetModified(dataf, labelf, subsampling = FALSE, R = 20, lambar =3)
adj_matrix <- result$diff.edge.weight

# Convert the adjacency matrix to a long format data frame for ggplot
